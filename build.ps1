...
$CommonFooter = @'
  ...
  <div class="mobile-fab" id="mobile-fab">
    <div class="mobile-fab-actions">
      <a href="/index.html#contact" class="fab-action">
        <div class="fab-action-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        </div>
        <span class="fab-action-label">Book Consultation</span>
      </a>
      <a href="https://wa.me/917838048195?text=Hello%20AstroInterior%2C%20I%20would%20like%20to%20book%20an%20Astro%20Interior%20Consultation." target="_blank" rel="noopener" class="fab-action">
        <div class="fab-action-btn" style="color: #25D366;">
        ...
        <span class="fab-action-label">WhatsApp</span>
      </a>
      <a href="tel:+917838048195" class="fab-action">
        <div class="fab-action-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        </div>
        <span class="fab-action-label">Call Now</span>
      </a>
      <a href="/assets/Transcend_Astro_Sample_Report.pdf" download="AstroInterior Sample Report.pdf" class="fab-action">
        <div class="fab-action-btn">
        ...
        <span class="fab-action-label">Sample Report</span>
      </a>
    </div>
    <button class="mobile-fab-trigger" id="mobile-fab-trigger" aria-label="Quick actions">
  ...
  <div class="bottom-sheet" id="founder-bottom-sheet">
    ...
    <div class="bottom-sheet-body">
      <div style="text-align: center; margin-bottom: 1.5rem;">
        <img src="/assets/founder_richa.png" alt="Richa Agarwal" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid var(--c-accent-border);">
      </div>
      <h4 style="font-family: var(--font-heading); font-size: 1.3rem; text-align: center; margin-bottom: 0.25rem;">Richa Agarwal</h4>
      ...
      <a href="/index.html#contact" class="btn-gold" style="width: 100%; text-align: center; display: block; padding: 0.9rem; font-size: 0.88rem; border-radius: 8px;">Book Consultation</a>
    </div>
  </div>

  <!-- Apple-Grade Floating Sticky Bottom Navigation Bar -->
  <div class="mobile-bottom-nav" id="mobile-bottom-nav">
    <a href="/index.html" class="mobile-bottom-link active" id="nav-btn-home">
    ...
    <a href="/index.html#services" class="mobile-bottom-link" id="nav-btn-services">
    ...
    <a href="/index.html#portfolio" class="mobile-bottom-link" id="nav-btn-portfolio">
    ...
    <a href="/index.html#sample-report" class="mobile-bottom-link" id="nav-btn-report">
    ...
    <a href="/index.html#contact" class="mobile-bottom-link" id="nav-btn-consult">
  ...
  <div class="search-overlay" id="search-overlay" aria-hidden="true" style="display: none;">
    <div class="search-modal-content" style="max-width: 600px; width: 100%; margin: 0 auto; display: flex; flex-direction: column; height: 100%;">
      <div class="search-header">
        <h3 style="font-family: var(--font-heading); font-size: 1.5rem; color: #FFF; margin: 0;">Global Search</h3>
        <button id="close-search-btn" aria-label="Close search" style="background: none; border: none; font-size: 2rem; cursor: pointer; color: rgba(255, 255, 255, 0.6); line-height: 1;">&times;</button>
      </div>
      ...
      <div class="search-input-wrap">
        ...
        <input type="text" class="search-input-field" id="global-search-input" placeholder="Search zodiac, rooms, colors, cities...">
      </div>
      
      <div class="search-results-panel" id="search-results-panel">
        <div style="text-align: center; color: rgba(255, 255, 255, 0.4); margin-top: 4rem;">
